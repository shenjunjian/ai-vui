...
- **包**：`vai`
- **导出**：`Option`
- **scene-theme 类名**：`sc-select-option`（规划，scene-theme 尚未实现）
...
2. 根元素挂载 `sc-select-option` + `st-*` 状态类
