...
- **包**：`@opentiny/vue-next`
- **导出**：`Cascader`
- **scene-theme 类名**：`sc-cascader`（规划，scene-theme 尚未实现）
...
> 待细化：补充 Cascader 专属 named slots。
