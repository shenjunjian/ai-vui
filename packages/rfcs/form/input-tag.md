...
> 状态：**草案** | 优先级：**P2** | 分类：**Form & Input 表单录入**
...
- **包**：`vai`
- **导出**：`InputTag`
- **scene-theme 类名**：`sc-input-tag`（规划，scene-theme 尚未实现）
...
> 待细化：补充 InputTag 专属 named slots。
