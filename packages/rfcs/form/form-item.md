...
- **包**：`vai`
- **导出**：`FormItem`
- **scene-theme 类名**：`sc-form-item`（规划，scene-theme 尚未实现）
...
> 待细化：补充 FormItem 专属 named slots。
