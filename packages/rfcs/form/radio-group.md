...
- **包**：`vai`
- **导出**：`RadioGroup`
- **scene-theme 类名**：`sc-radio-group`（规划，scene-theme 尚未实现）
...
> 待细化：补充 RadioGroup 专属 named slots。
...
- Custom Element：`tvp-radio-group`
