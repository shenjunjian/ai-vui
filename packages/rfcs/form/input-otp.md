...
- **包**：`vai`
- **导出**：`InputOTP`
- **scene-theme 类名**：`sc-input-otp`（规划，scene-theme 尚未实现）
...
> 待细化：补充 InputOTP 专属 named slots。
