...
- **包**：`@opentiny/vue-next`
- **导出**：`Calendar`
- **scene-theme 类名**：`sc-calendar`（规划，scene-theme 尚未实现）
...
> 待细化：补充 Calendar 专属 named slots。
