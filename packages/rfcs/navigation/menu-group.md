...
- **包**：`vai`
- **导出**：`MenuGroup`
- **scene-theme 类名**：`sc-menu-group`（规划，scene-theme 尚未实现）
...
> 待细化：补充 MenuGroup 专属 named slots。
