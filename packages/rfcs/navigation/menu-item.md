...
- **包**：`@opentiny/vue-next`
- **导出**：`MenuItem`
- **scene-theme 类名**：`sc-menu-item`（规划，scene-theme 尚未实现）
...
> 待细化：补充 MenuItem 专属 named slots。
