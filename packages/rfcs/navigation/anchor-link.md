...
- **包**：`vai`
- **导出**：`AnchorLink`
- **scene-theme 类名**：`sc-anchor-link`（规划，scene-theme 尚未实现）
...
> 待细化：补充 AnchorLink 专属 named slots。
...
- Custom Element：`tvp-anchor-link`
