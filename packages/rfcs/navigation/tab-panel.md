...
- **包**：`vai`
- **导出**：`TabPanel`
- **scene-theme 类名**：`sc-tab-panel`（规划，scene-theme 尚未实现）
...
> 待细化：补充 TabPanel 专属 named slots。
