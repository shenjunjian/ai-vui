...
- **包**：`@opentiny/vue-next`
- **导出**：`Flex`
- **scene-theme 类名**：`sc-flexr / sc-flexc`（规划，scene-theme 尚未实现）
...
2. 根元素挂载 `sc-flexr / sc-flexc` + `st-*` 状态类
