...
- **包**：`vai`
- **导出**：`Splitter`
- **scene-theme 类名**：`sc-splitter`（规划，scene-theme 尚未实现）
...
> 待细化：补充 Splitter 专属 named slots。
