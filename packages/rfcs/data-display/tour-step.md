...
- **包**：`vai`
- **导出**：`TourStep`
- **scene-theme 类名**：`sc-tour-step`（规划，scene-theme 尚未实现）
...
> 待细化：补充 TourStep 专属 named slots。
