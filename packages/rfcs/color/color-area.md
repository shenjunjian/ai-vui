...
- **包**：`vai`
- **导出**：`ColorArea`
- **scene-theme 类名**：`sc-color-area`（规划，scene-theme 尚未实现）
...
> 待细化：补充 ColorArea 专属 named slots。
