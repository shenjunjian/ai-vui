...
- **包**：`@opentiny/vue-next`
- **导出**：`ColorField`
- **scene-theme 类名**：`sc-color-field`（规划，scene-theme 尚未实现）
...
> 待细化：补充 ColorField 专属 named slots。
...
- Custom Element：`tvp-color-field`
